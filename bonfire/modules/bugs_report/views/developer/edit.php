...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            ...
            or <?php echo anchor(SITE_AREA .'/developer/bugs_report', lang('bugs_report_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('Bugs_report.Developer.Delete')) : ?>

            or <a class="btn btn-danger" id="delete-me" href="<?php echo site_url(SITE_AREA .'/developer/bugs_report/delete/'. $id);?>" onclick="return confirm('<?php echo lang('bugs_report_delete_confirm'); ?>')" name="delete-me">
