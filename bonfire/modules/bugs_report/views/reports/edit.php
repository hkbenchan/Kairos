...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    ...
    <?php if ($this->auth->has_permission('Bugs_report.Reports.Delete')) : ?>

            or <a class="btn btn-danger" id="delete-me" href="<?php echo site_url(SITE_AREA .'/reports/bugs_report/delete/'. $id);?>" onclick="return confirm('<?php echo lang('bugs_report_delete_confirm'); ?>')" name="delete-me">
