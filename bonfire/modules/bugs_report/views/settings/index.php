<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Bugs_report.Settings.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('Bugs_report.Settings.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/settings/bugs_report/edit/'. $record->bug_id, '<i class="icon-pencil">&nbsp;</i>' .  $record->bugs_report_bug_type) ?></td>
				<?php else: ?>
