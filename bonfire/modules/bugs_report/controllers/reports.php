...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Bugs_report.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Bugs_report.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_bugs_report())
			{
				...
				Template::redirect(SITE_AREA .'/reports/bugs_report');
			}
			else
			{
	...
	*/
	...
	{
		$this->auth->restrict('Bugs_report.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/bugs_report');
		}
	...
	*/
	...
	{
		$this->auth->restrict('Bugs_report.Reports.Delete');
