...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Bugs_report.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Bugs_report.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_bugs_report())
			{
				...
				Template::redirect(SITE_AREA .'/developer/bugs_report');
			}
			else
			{
	...
	*/
	...
	{
		$this->auth->restrict('Bugs_report.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/bugs_report');
		}
	...
	*/
	...
	{
		$this->auth->restrict('Bugs_report.Developer.Delete');
