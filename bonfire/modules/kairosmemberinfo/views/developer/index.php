	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('KairosMemberInfo.Developer.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/developer/kairosmemberinfo/edit/'. $record->entry_id, '<i class="icon-pencil">&nbsp;</i>' .  $record->kairosmemberinfo_surname) ?></td>
				<?php else: ?>
