...
<?php $options = array(
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="submit" class="btn btn-primary" value="Edit KairosMemberInfo" />
            or <?php echo anchor(SITE_AREA .'/developer/kairosmemberinfo', lang('kairosmemberinfo_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('KairosMemberInfo.Developer.Delete')) : ?>

            or <a class="btn btn-danger" id="delete-me" href="<?php echo site_url(SITE_AREA .'/developer/kairosmemberinfo/delete/'. $id);?>" onclick="return confirm('<?php echo lang('kairosmemberinfo_delete_confirm'); ?>')" name="delete-me">
            <i class="icon-trash icon-white">&nbsp;</i>&nbsp;<?php echo lang('kairosmemberinfo_delete_record'); ?>
            </a>
