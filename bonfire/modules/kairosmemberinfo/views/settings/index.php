<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('KairosMemberInfo.Settings.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('KairosMemberInfo.Settings.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/settings/kairosmemberinfo/edit/'. $record->entry_id, '<i class="icon-pencil">&nbsp;</i>' .  $record->kairosmemberinfo_surname) ?></td>
				<?php else: ?>
