...
<?php $options = array(
        ...
        <div class="form-actions">
            ...
            or <?php echo anchor(SITE_AREA .'/reports/kairosmemberinfo', lang('kairosmemberinfo_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('KairosMemberInfo.Reports.Delete')) : ?>

            or <a class="btn btn-danger" id="delete-me" href="<?php echo site_url(SITE_AREA .'/reports/kairosmemberinfo/delete/'. $id);?>" onclick="return confirm('<?php echo lang('kairosmemberinfo_delete_confirm'); ?>')" name="delete-me">
