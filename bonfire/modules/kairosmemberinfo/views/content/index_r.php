...
<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('KairosMemberInfo.Content.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('KairosMemberInfo.Content.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/content/kairosmemberinfo/edit/'. $record->entry_id, '<i class="icon-pencil">&nbsp;</i>' .  $record->kairosmemberinfo_firstname) ?></td>
				<?php else: ?>
				<td><?php echo $record->kairosmemberinfo_firstname ?></td>
				<?php endif; ?>
				...
				<td><?php echo $record->kairosmemberinfo_nationalityID?></td>
				<td><?php echo $record->kairosmemberinfo_gender?></td>
				<td><?php echo $record->kairosmemberinfo_UniversityID?></td>
