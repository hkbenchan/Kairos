...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		       ...
		       <div class='controls'>
				...
				<?php
					$descrVenture = array(
						...
						'rows' => '10',
						'cols' => '40',
						'value' => isset($kairosmemberinfo_ventureDescr) ? $kairosmemberinfo_ventureDescr : (isset($kairosmemberinfo['kairosmemberinfo_ventureDescr']) ? $kairosmemberinfo['kairosmemberinfo_ventureDescr']: '')
					);
				?>
    ...
    <?php if ($this->auth->has_permission('KairosMemberInfo.Content.Delete')) : ?>
            ...
            or <a class="btn btn-danger" id="delete-me" href="<?php echo site_url(SITE_AREA .'/content/kairosmemberinfo/delete/'. $id);?>" onclick="return confirm('<?php echo lang('kairosmemberinfo_delete_confirm'); ?>')" name="delete-me">
