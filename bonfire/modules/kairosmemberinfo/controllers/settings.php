...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('KairosMemberInfo.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('KairosMemberInfo.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_kairosmemberinfo())
			{
				...
				Template::redirect(SITE_AREA .'/settings/kairosmemberinfo');
			}
			else
			{
	...
	*/
	...
	{
		$this->auth->restrict('KairosMemberInfo.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/kairosmemberinfo');
		}
	...
	*/
	...
	{
		$this->auth->restrict('KairosMemberInfo.Settings.Delete');
