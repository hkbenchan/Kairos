...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('KairosMemberInfo.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('KairosMemberInfo.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_kairosmemberinfo())
			{
				...
				Template::redirect(SITE_AREA .'/developer/kairosmemberinfo');
			}
			else
			{
	...
	*/
	...
	{
		$this->auth->restrict('KairosMemberInfo.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/kairosmemberinfo');
		}
	...
	*/
	...
	{
		$this->auth->restrict('KairosMemberInfo.Developer.Delete');
